            ...
            if(tutor_utils()->is_course_added_to_cart($product_id, true)){
                ?>
                    <a href="<?php echo wc_get_cart_url(); ?>">
                        <button class="tutor-button"><?php _e('Purchase Now', 'tutor'); ?></button>
                    </a>
                <?php
            }
            else{
                ...
                <form class="cart"
                    ...
                    <button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button tutor-button alt wew"> Purchase Now
                    </button>
