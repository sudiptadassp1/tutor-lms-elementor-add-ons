            ...
            <div class="row">
                <?php
                    if($post_object->have_posts()) :
                        ...
                        if($flag < 2){
                            if($flag == 0){ _e("<div class='col-lg-3 col-md-12 col-sm-12'>"); }
                            ?>
                                <div class='col-lg-12 col-md-12 col-sm-12 blog_card'>
                            ...
                            ?>
                                <div class='col-lg-6 col-md-12 col-sm-12'>
                                    <div class="col-lg-12 col-md-12 col-sm-12 second blog_card">
                            ...
                            if($flag == 3){ _e("<div class='col-lg-3 col-md-12 col-sm-12'>"); }
                            ?>
                                <div class='col-lg-12 col-md-12 col-sm-12 blog_card'>
                                    <div class="blog-box style-1">
                                        <div class="figure-box">
